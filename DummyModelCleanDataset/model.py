...
dataset_file_path = './../BERTBaseBatchesModel/DatasetCleaner/Embeddings/embeddings.csv'
...
custom_cmap = LinearSegmentedColormap.from_list("custom", ['#CFE3EC', '#10739E'])
...
plt.title('Matricea de confuzie', fontsize=14)
plt.xlabel('Etichete prezise', fontsize=12)
plt.ylabel('Etichete reale', fontsize=12)
