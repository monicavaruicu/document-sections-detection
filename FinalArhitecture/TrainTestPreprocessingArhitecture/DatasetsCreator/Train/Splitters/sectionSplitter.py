...
def split_into_sections(outputFile):
    ...
    with open(output_csv, mode='w', newline='', encoding='utf-8') as out_file:
        ...
        # for file in txt_files[90:n]: # batch 1
        # for file in txt_files[0:90] + txt_files[178:n]: # batch 2
        # for file in txt_files[0:178] + txt_files[266:n]: # batch 3
        txt_files = txt_files[0:266] # batch 4
