...
train_df = pd.read_csv('Train/train_embeddings.csv')
test_df = pd.read_csv('Test/test_embeddings.csv')
...
output_df.to_csv("results_with_batches.csv", index=False, encoding='utf-8')
